...
class StudySessionController {
  ...
  @PutMapping("/{id}")
  StudySessionResponse revise(
      @PathVariable UUID id, @Valid @RequestBody ReviseStudySessionRequest request) {
    return StudySessionResponse.from(
        service.reviseStudySession(
            id,
  ...
  List<StudySessionResponse> history(@PathVariable UUID learningGoalId) {
    return service.findStudyHistory(learningGoalId).stream()
